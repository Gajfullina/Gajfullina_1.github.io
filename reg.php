...
<div class="col">
        <h1>Форма регистрации</h1>
    <form action="validation-formregister.php" method="post">
        <label for="fio">ФИО:</label><br>
        <input type="text" class="form-control" name="fio" id="fio" placeholder="Введите ФИО" required><br><br>
        ...
        <label for="password">Пароль:</label><br>
        <input type="password" class="form-control" name="password" id="password" placeholder="Введите пароль" required><br><br>
